...
def visualize_Seg(img, mask, preds, slice=62, figsize=(10, 6), row=2, col=2, epoch=None):
...
# Visualize predictions:
def visualize_Rec(img, mask_1, mask_2, preds_1, preds_2, slice=62, figsize=(10, 6), row=2, col=2, epoch=None):
